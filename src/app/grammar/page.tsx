  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-8 md:py-12">
      <section className="text-center">
        ...
        <p className="mx-auto mt-3 max-w-2xl font-deva leading-relaxed text-cream-200/80">
        ...
        <p className="mx-auto mt-3 max-w-2xl rounded-xl border border-ochre-500/30 bg-ochre-500/10 px-4 py-2 text-sm text-cream-100">
